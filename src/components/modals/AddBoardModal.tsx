...
export default function AddBoardModal({ closeAddBoardModal }: AddBoardModalProps) {
    ...
    return (
        <form onSubmit={(e) => handleSumbit(e)} className="bg-white overflow-y-auto max-h-200 pop-in dark:bg-dark-gray rounded-lg p-6 sm:p-8 space-y-6 theme-transition w-full xs:w-86 sm:w-120">
